...
from documents_functions import set_table_params

###########################   CREATE DOC FUNCTION   ############################
def create_doc_1(data: dict) -> None:
    document = Document()
...
###############################      TABLE1      ###############################
    ...
    set_table_params(table = table_1,
...
###############################      TABLE2      ###############################
    ...
    set_table_params(table = table_2,
...
###############################      FOOTER      ###############################
    ...
    set_table_params(table = table_3,
